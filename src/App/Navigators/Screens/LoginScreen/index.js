...
import {getAuth} from './../../../Stores/Actions/Signin';
...
const LoginScreen = props => {
  ...
  const signin = useSelector(initialAppState => initialAppState.signin);
  ...
  // }, [signin.isFetching]);
  const submit = values => {
    dispatch(getAuth(values.email, values.password));
  };
  return (
